...
public class DisitivosBT extends AppCompatActivity {

    //1)
    // Depuración de LOGCAT
    private static final String TAG = "DisitivosBT"; //<-<- PARTE A MODIFICAR >->->
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_disitivos_bt);
    ...
    private AdapterView.OnItemClickListener mDeviceClickListener = new AdapterView.OnItemClickListener() {
        public void onItemClick(AdapterView av, View v, int arg2, long arg3) {
            ...
            Intent i = new Intent(DisitivosBT.this, interfazdeusuario.class);//<-<- PARTE A MODIFICAR >->->
